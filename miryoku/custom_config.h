...
&kp LSHFT,         &kp A,             &kp S,             &kp D,             &kp F,             &kp G,             &kp H,             &kp J,             &kp K,             &kp L,             &kp SQT,           &kp TILDE,         \
&kp LCTRL,         &kp Z,             &kp X,             &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         &kp DOT,           &kp SLASH,         U_NP,              \
...
XXX  K20  K21  K22  K23  K24       K25  K26  K27  K28  K29  &u_to_U_GAME \

...
&kp TAB,           &kp Q,             &kp W,             &kp E,             &kp R,             &kp P,             &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             &kp LALT,          \
&kp LSHFT,         &kp T,             &kp S,             &kp D,             &kp F,             &kp V,             &kp H,             &kp J,             &kp K,             &kp L,             &kp SQT,           &kp TILDE,         \
&kp LCTRL,         &kp NUMBER_1,      &kp NUMBER_2,      &kp NUMBER_3,      &kp NUMBER_4,      &kp B,             &kp N,             &kp M,             &kp COMMA,         &kp DOT,           &kp SLASH,         U_NP,              \
